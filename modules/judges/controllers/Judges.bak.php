<?php
    class Judges extends Trongate {
        ...
        function submit_score() {
            ...
            $score = (float)post('score', true); // Ensure score is a valid value (1.0 to 10.0, etc.)
        ...
        public function _get_missing_score($heat_id, $judge_id) {
            ...
            $sql = "SELECT
                ...
                SUM(CASE WHEN js_oth.judge_id <> :judge_id AND js_oth.score IS NOT NULL THEN 1 ELSE 0 END) AS others_scored
                FROM (
                ...
                WHERE (js_me.id IS NULL OR js_me.score IS NULL)
