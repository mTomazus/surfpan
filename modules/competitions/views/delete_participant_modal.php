<div class="modal-delete-body ">
    ...
    <form mx-delete="competitions/submit_delete_participant/<?= $update_id ?>" mx-close-on-success="true" mx-target="#response" mx-on-success="#participants-list" mx-animate-success="true">
